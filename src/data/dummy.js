...
const gridStudentCountry = (props) => (
...
export const EditorData = () => (
  <div>
    <h3>
      The Suvidha Foundation (Suvidha Mahila Mandal) is a non-profit
      organization that aims to empower communities through education,
      innovation, and empowerment: Education The foundation offers scholarships,
      student internships, and mentorship programs to help underprivileged
      children and those facing financial challenges. Women's empowerment The
      foundation supports women's growth through research and skill development
      initiatives. Environmental sustainability The foundation promotes
      environmental sustainability through tree plantation drives and fostering
      greener practices. Healthcare The foundation facilitates access to
      affordable, quality healthcare services. Social awareness The foundation
      runs campaigns on hygiene, healthcare, and environmental sustainability.
      Research and innovation The foundation has made significant contributions
      to the fields of Natural Language Processing (NLP) and AI. The
      foundation's founder and secretary is Shobha Motghare. The foundation has
      won numerous awards, including the Global Sustainability Award 2024
    </h3>
  </div>
);
